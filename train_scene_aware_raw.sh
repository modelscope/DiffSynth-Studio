#!/bin/bash
# Phase 0c: Retrain FLUX ControlNet LoRA on RAW_empty with scene-aware split
# Starting from scratch (no checkpoint resume) to avoid leaky-split contamination.

source ~/miniconda3/etc/profile.d/conda.sh
conda activate diffsynth

DATASET_BASE_PATH="/home/jw/engsci/thesis/spad/spad_dataset"
OUTPUT_PATH="./models/train/FLUX-SPAD-LoRA-SceneAware-RAW"
LOG_DIR="./logs/flux_spad_lora_scene_aware_raw"
