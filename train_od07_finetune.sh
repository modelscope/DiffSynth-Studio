#!/bin/bash
# Phase 4a-i: Fine-tune RAW_empty checkpoint on OD_07 data

source ~/miniconda3/etc/profile.d/conda.sh
conda activate diffsynth

DATASET_BASE_PATH="/home/jw/engsci/thesis/spad/spad_dataset"
OUTPUT_PATH="./models/train/FLUX-SPAD-LoRA-SceneAware-OD07-FT"
LOG_DIR="./logs/flux_spad_lora_scene_aware_od07_ft"
...
TRAIN_CSV="${DATASET_BASE_PATH}/bits_RAW_OD_07/metadata_train.csv"
VAL_CSV="${DATASET_BASE_PATH}/bits_RAW_OD_07/metadata_val.csv"

echo "=========================================="
echo "FLUX LoRA -- OD_07 Fine-tuned from RAW_empty"
echo "=========================================="
