...
def add_gradient_config(parser: argparse.ArgumentParser):
    ...
    parser.add_argument("--param_size_threshold", type=int, default=None, help="When --cpu_offload is enabled, modules with total params above this threshold (in MB) are recursively split into children. None means offload every leaf module directly. Default: None.")
    return parser
