...
def add_model_config(parser: argparse.ArgumentParser):
    ...
    parser.add_argument("--fp8_models", default=None, type=str, help="Models with FP8 precision, comma-separated. Accepts exact file paths or logical component names (e.g. dit, vae, text_encoder) matched by model name.")
    parser.add_argument("--offload_models", default=None, type=str, help="Models with offload, comma-separated. Only used in splited training. Accepts exact file paths or logical component names (e.g. dit, vae, text_encoder) matched by model name.")
