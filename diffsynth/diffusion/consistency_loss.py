"""
Phase 3c: Per-Frame Consistency Loss (IC-Light inspired)
...
def FlowMatchSFTWithConsistencyLoss(
    ...
    **inputs,
    ...
    The loss is: L = L_flow_match + lambda * ||v_F1 - v_F2||^2
    """
    ...
    # Forward pass with frame F1 (standard controlnet conditioning)
    ...
    # Forward pass with frame F2 (swapped controlnet conditioning)
    ...
    if conditionings_f2 is not None:
        ...
        inputs_f2["latents"] = noisy_latents  # Same noisy input
