...
|[FLUX.1-Kera-dev](https://www.modelscope.cn/models/black-forest-labs/FLUX.1-Krea-dev)||[code](./examples/flux/model_inference/FLUX.1-Kera-dev.py)|[code](./examples/flux/model_inference_low_vram/FLUX.1-Kera-dev.py)|[code](./examples/flux/model_training/full/FLUX.1-Kera-dev.sh)|[code](./examples/flux/model_training/validate_full/FLUX.1-Kera-dev.py)|[code](./examples/flux/model_training/lora/FLUX.1-Kera-dev.sh)|[code](./examples/flux/model_training/validate_lora/FLUX.1-Kera-dev.py)|
...
## Update History
- **August 1, 2025** [FLUX.1-Kera-dev](https://www.modelscope.cn/models/black-forest-labs/FLUX.1-Krea-dev) with a focus on aesthetic photography is comprehensively supported, including low-GPU-memory layer-by-layer offload, LoRA training and full training. See [./examples/flux/](./examples/flux/).
