...
accelerate launch examples/wanvideo/model_training/train.py \
  ...
  --output_path "./models/train/Wan-Animate-2-14B_lora_splited_cache" \
  --lora_base_model "dit" \
...
accelerate launch --config_file examples/wanvideo/model_training/full/accelerate_config_14B.yaml examples/wanvideo/model_training/train.py \
  --dataset_base_path models/train/Wan-Animate-2-14B_lora_splited_cache \
  --data_file_keys "video,animate2_reference_image,animate2_reference_video" \
  --height 640 \
  --width 352 \
  --num_frames 81 \
  ...
  --num_epochs 5 \
  --remove_prefix_in_ckpt "pipe.dit." \
  --output_path "./models/train/Wan-Animate-2-14B_lora" \
  --lora_base_model "dit" \
  --lora_target_modules "self_attn.q,self_attn.k,self_attn.v" \
  --lora_rank 32 \
  --extra_inputs "animate2_prompt_ref,animate2_reference_image,animate2_reference_video" \
