...
pipe.load_lora(pipe.dit, str(latest_checkpoint('./models/train/Wan2.1-T2V-1.3B_split')), alpha=1)
...
save_video(video, 'split_training_Wan2.1-T2V-1.3B.mp4', fps=15, quality=5)
