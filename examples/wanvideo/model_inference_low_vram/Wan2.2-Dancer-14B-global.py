...
pipe = WanVideoPipeline.from_pretrained(
    ...
    device="cuda",
    model_configs=[
        ModelConfig(model_id="Wan-AI/Wan2.2-Dancer-14B", origin_file_pattern="global_model.safetensors", **vram_config),
        ModelConfig(model_id="Wan-AI/Wan2.2-Dancer-14B", origin_file_pattern="models_t5_umt5-xxl-enc-bf16.pth", **vram_config),
        ModelConfig(model_id="Wan-AI/Wan2.2-Dancer-14B", origin_file_pattern="Wan2.1_VAE.pth", **vram_config),
        ModelConfig(model_id="Wan-AI/Wan2.2-Dancer-14B", origin_file_pattern="models_clip_open-clip-xlm-roberta-large-vit-huge-14.pth", **vram_config),
    ],
