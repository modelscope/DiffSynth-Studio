...
accelerate launch examples/anima/model_training/train.py \
  ...
  --output_path ./models/train/anima-preview_split_cache \
  --lora_base_model dit \
  --lora_target_modules '' \
  --lora_rank 32 \
  --use_gradient_checkpointing \
  --offload_models circlestone-labs/Anima:split_files/diffusion_models/anima-preview.safetensors \
  --task sft:data_process

# Stage 2: train LoRA from the cached dataset.
accelerate launch examples/anima/model_training/train.py \
  --dataset_base_path ./models/train/anima-preview_split_cache \
  --max_pixels 1048576 \
  --dataset_repeat 50 \
  --model_id_with_origin_paths circlestone-labs/Anima:split_files/diffusion_models/anima-preview.safetensors,circlestone-labs/Anima:split_files/text_encoders/qwen_3_06b_base.safetensors,circlestone-labs/Anima:split_files/vae/qwen_image_vae.safetensors \
  --tokenizer_path Qwen/Qwen3-0.6B:./ \
  ...
  --num_epochs 5 \
  --remove_prefix_in_ckpt pipe.dit. \
  --output_path ./models/train/anima-preview_split \
  --lora_base_model dit \
  --lora_target_modules '' \
  --lora_rank 32 \
  --use_gradient_checkpointing \
  --offload_models circlestone-labs/Anima:split_files/text_encoders/qwen_3_06b_base.safetensors,circlestone-labs/Anima:split_files/vae/qwen_image_vae.safetensors \
  --task sft:train
