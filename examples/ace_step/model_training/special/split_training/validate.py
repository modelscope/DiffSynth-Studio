...
pipe.load_lora(pipe.dit, str(latest_checkpoint('./models/train/acestep-v15-xl-sft_split')), alpha=1)
...
save_audio(audio, pipe.vae.sampling_rate, 'split_training_acestep-v15-xl-sft.wav')
