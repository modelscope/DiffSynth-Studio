...
state_dict = load_state_dict("models/train/JoyAI-Image-Edit_lora/epoch-1.safetensors")
pipe.dit.load_state_dict(state_dict, strict=False)

prompt = "Turn the plate blue"
image = Image.open("data/example_image_dataset/edit/image1.jpg").resize((1024, 1024))
image = pipe(prompt, input_image=image, seed=0, num_inference_steps=50, cfg_scale=5.0)
