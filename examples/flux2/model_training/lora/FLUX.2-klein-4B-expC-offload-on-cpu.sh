# =============================================================================
# 实验 C：FLUX.2-klein-4B LoRA 训练 — cpu_offload + optimize_on_cpu=True
# 所有参数 offload 到 CPU，optimizer 在 CPU
# =============================================================================
...
accelerate launch examples/flux2/model_training/train.py \
  ...
  --output_path "./models/train/FLUX.2-klein-4B_lora_offload_on_cpu" \
  --lora_base_model "dit" \
