# =============================================================================
# 实验 B：FLUX.2-klein-4B LoRA 训练 — cpu_offload + optimize_on_cpu=False
# 冻结参数 offload 到 CPU，可训练参数（LoRA）留 GPU，optimizer 在 GPU
# =============================================================================
...
accelerate launch examples/flux2/model_training/train.py \
  ...
  --output_path "./models/train/FLUX.2-klein-4B_lora_offload_on_gpu" \
  --lora_base_model "dit" \
