...
pipe = LTX2AudioVideoPipeline.from_pretrained(
    ...
    model_configs=[
        ...
        ModelConfig(path="./models/train/LTX2.5-I2AV-full/epoch-1.safetensors", **vram_config),
...
image = VideoData("data/diffsynth_example_dataset/ltx2/LTX-2.5-I2AV-splited/video.mp4", height=height, width=width)[0]
video, audio = pipe(
    prompt=prompt,
...
write_video_audio_ltx2(
    video=video,
    audio=audio,
    output_path="ltx2.5_i2av_full.mp4",
    fps=24,
