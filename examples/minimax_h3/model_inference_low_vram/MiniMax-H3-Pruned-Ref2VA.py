...
pipe = MiniMaxH3Pipeline.from_pretrained(
    ...
    model_configs=[
        ...
        ModelConfig(model_id="Comfy-Org/MiniMax-H3", origin_file_pattern="diffusion_models/minimax_h3_ref2va_pruned_bf16.safetensors", **vram_config),
...
video, audio = pipe(
    ...
    references=[{"type": "image", "image": Image.open("data/diffsynth_example_dataset/minimax_h3/MiniMax-H3-Pruned-Ref2VA/0.png").convert("RGB")}]
)
write_video_audio(
...
ref_video, ref_video_audio, ref_video_sample_rate = read_video_audio(
    "data/diffsynth_example_dataset/minimax_h3/MiniMax-H3-Pruned-Ref2VA/video.mp4",
...
ref_voice, ref_voice_sample_rate = read_audio(
    "data/diffsynth_example_dataset/minimax_h3/MiniMax-H3-Pruned-Ref2VA/voice.mp3", duration=len(ref_video) / 24, resample=True, resample_rate=pipe.audio_vae.sample_rate,
)
