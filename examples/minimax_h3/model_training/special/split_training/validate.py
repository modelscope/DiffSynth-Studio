...
pipe.clear_lora()
pipe.load_lora(pipe.dit, str(latest_checkpoint('./models/train/MiniMax-H3-FL2VA-split')))
video, audio = pipe(
    prompt=prompt,
...
write_video_audio(
    video=video, audio=audio, output_path='split_training_MiniMax-H3-FL2VA.mp4',
