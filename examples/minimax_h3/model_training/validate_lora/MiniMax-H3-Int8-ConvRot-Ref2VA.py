...
pipe.load_lora(pipe.dit, "models/train/MiniMax-H3-Ref2VA-int8-convrot/epoch-4.safetensors")
...
write_video_audio(
    video=video, audio=audio, output_path="minimax_h3_ref2va_lora_int8_convrot.mp4",
    fps=24, audio_sample_rate=pipe.audio_vae.sample_rate,
)
print("saved minimax_h3_ref2va_lora_int8_convrot.mp4", "frames:", len(video), "audio:", tuple(audio.shape))
