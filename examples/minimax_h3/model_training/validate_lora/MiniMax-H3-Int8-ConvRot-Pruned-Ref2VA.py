...
pipe.load_lora(pipe.dit, "models/train/MiniMax-H3-Ref2VA-pruned-int8-convrot/epoch-4.safetensors")

dataset_snapshot_download(
    dataset_id="DiffSynth-Studio/diffsynth_example_dataset",
    local_dir="data/diffsynth_example_dataset",
    allow_file_pattern="minimax_h3/MiniMax-H3-Pruned-Ref2VA/*",
)
...
write_video_audio(
    video=video, audio=audio, output_path="minimax_h3_ref2va_lora_pruned_int8_convrot.mp4",
    fps=24, audio_sample_rate=pipe.audio_vae.sample_rate,
)
print("saved minimax_h3_ref2va_lora_pruned_int8_convrot.mp4", "frames:", len(video), "audio:", tuple(audio.shape))
