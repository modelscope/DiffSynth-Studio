...
pipe = MiniMaxH3Pipeline.from_pretrained(
    ...
    model_configs=[
        ...
        ModelConfig(model_id="MiniMax/MiniMax-H3", origin_file_pattern="Ref2VA/transformer/model*.safetensors", quantize=QuantizeConfig(method="bitsandbytes_nf4", exclude_modules=exclude_modules), **vram_config),
...
pipe.load_lora(pipe.dit, "models/train/MiniMax-H3-Ref2VA_quant_lora/epoch-4.safetensors")
...
write_video_audio(
    video=video, audio=audio, output_path="minimax_h3_ref2va_lora_bitsandbytes_nf4.mp4",
    fps=24, audio_sample_rate=pipe.audio_vae.sample_rate,
)
print("saved minimax_h3_ref2va_lora_bitsandbytes_nf4.mp4", "frames:", len(video), "audio:", tuple(audio.shape))
