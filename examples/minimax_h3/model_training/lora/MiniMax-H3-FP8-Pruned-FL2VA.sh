...
accelerate launch examples/minimax_h3/model_training/train.py \
  ...
  --num_frames 124 \
  --dataset_repeat 1 \
  --model_id_with_origin_paths "MiniMax/MiniMax-H3:FL2VA/text_encoder/model*.safetensors,Comfy-Org/MiniMax-H3:diffusion_models/minimax_h3_fl2va_pruned_fp8_scaled.safetensors,MiniMax/MiniMax-H3:FL2VA/video_vae/source/model.safetensors,MiniMax/MiniMax-H3:FL2VA/audio_vae/model.safetensors" \
  --remove_prefix_in_ckpt "pipe.dit." \
  --output_path "./models/train/MiniMax-H3-T2VA-pruned-fp8-cache" \
  --lora_base_model "dit" \
...
accelerate launch examples/minimax_h3/model_training/train.py \
  --dataset_base_path "./models/train/MiniMax-H3-T2VA-pruned-fp8-cache" \
  --num_frames 124 \
  --dataset_repeat 100 \
  --model_id_with_origin_paths "Comfy-Org/MiniMax-H3:diffusion_models/minimax_h3_fl2va_pruned_fp8_scaled.safetensors" \
  --learning_rate 1e-4 \
  --num_epochs 5 \
  --remove_prefix_in_ckpt "pipe.dit." \
  --output_path "./models/train/MiniMax-H3-T2VA-pruned-fp8" \
  --lora_base_model "dit" \
  --lora_target_modules "attn.qkv_proj,attn.out_proj,mlp.fc1,mlp.fc2" \
  --lora_rank 32 \
  --use_gradient_checkpointing \
...
accelerate launch examples/minimax_h3/model_training/train.py \
  ...
  --model_id_with_origin_paths "MiniMax/MiniMax-H3:FL2VA/text_encoder/model*.safetensors,Comfy-Org/MiniMax-H3:diffusion_models/minimax_h3_fl2va_pruned_fp8_scaled.safetensors,MiniMax/MiniMax-H3:FL2VA/video_vae/source/model.safetensors,MiniMax/MiniMax-H3:FL2VA/audio_vae/model.safetensors" \
  --remove_prefix_in_ckpt "pipe.dit." \
  --output_path "./models/train/MiniMax-H3-FL2VA-pruned-fp8-cache" \
  --lora_base_model "dit" \
  --lora_target_modules "attn.qkv_proj,attn.out_proj,mlp.fc1,mlp.fc2" \
  --lora_rank 32 \
  --use_gradient_checkpointing \
...
# FL2VA - stage 2
accelerate launch examples/minimax_h3/model_training/train.py \
  --dataset_base_path "./models/train/MiniMax-H3-FL2VA-pruned-fp8-cache" \
  --num_frames 124 \
  --dataset_repeat 100 \
  --model_id_with_origin_paths "Comfy-Org/MiniMax-H3:diffusion_models/minimax_h3_fl2va_pruned_fp8_scaled.safetensors" \
  --learning_rate 1e-4 \
  --num_epochs 5 \
  --remove_prefix_in_ckpt "pipe.dit." \
  --output_path "./models/train/MiniMax-H3-FL2VA-pruned-fp8" \
  --lora_base_model "dit" \
  --lora_target_modules "attn.qkv_proj,attn.out_proj,mlp.fc1,mlp.fc2" \
  --lora_rank 32 \
  --use_gradient_checkpointing \
