...
class BooguImageTrainingModule(DiffusionTrainingModule):
    def __init__(
        self,
        ...
        processor_config = ModelConfig(model_id="Boogu/Boogu-Image-0.1-Base", origin_file_pattern="mllm/") if processor_path is None else ModelConfig(processor_path)
...
def boogu_image_parser():
    parser = argparse.ArgumentParser(description="Boogu-Image training.")
