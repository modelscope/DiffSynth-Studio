...
pipe.load_lora(pipe.dit, str(latest_checkpoint('./models/train/Ideogram-4-bf16-repackage_split')), alpha=1)
# pipe.load_lora(pipe.dit_uncond, str(latest_checkpoint('./models/train/Ideogram-4-bf16-repackage_split')), alpha=1)
