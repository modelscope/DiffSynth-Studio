...
pipe.load_lora(pipe.video_dit, str(latest_checkpoint('./models/train/MOVA-360p-I2AV_high_noise_split')))
negative_prompt = (
...
write_video_audio(video, audio, 'split_training_MOVA-360p-I2AV.mp4', fps=24, audio_sample_rate=pipe.audio_vae.sample_rate)
