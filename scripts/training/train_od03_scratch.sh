#!/bin/bash
# Phase 4a-ii: Train OD_03 from scratch (comparison experiment)

source ~/miniconda3/etc/profile.d/conda.sh
conda activate diffsynth

DATASET_BASE_PATH="/home/jw/engsci/thesis/spad/spad_dataset"
OUTPUT_PATH="./models/train/FLUX-SPAD-LoRA-SceneAware-OD03-Scratch"
LOG_DIR="./logs/flux_spad_lora_scene_aware_od03_scratch"
...
echo "=========================================="
echo "FLUX LoRA -- OD_03 From Scratch"
echo "=========================================="
